// server.js - OpenAI to NVIDIA NIM API Proxy (fixed & streaming ready)
...
// Middleware - increased body size for large chat history
app.use(cors());
...
const MODEL_MAPPING = {
  ...
  'gemini-pro': 'qwen/qwen3-next-80b-a3b-thinking' // janitor gemini-pro goes here
};
